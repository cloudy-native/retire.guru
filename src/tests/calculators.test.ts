...
describe("updateFinancialParam", () => {
	test("updates a specific parameter correctly", () => {
		...
		const updatedParams = updateFinancialParam(
			initialParams,
			"initialBalance",
			150000,
		);
...
describe("calculateScenario", () => {
	...
	test("handles funds depletion cases", () => {
		...
		expect(finalYear.endingBalance).toBeLessThan(
			depletingParams.initialBalance * 0.5,
		);
