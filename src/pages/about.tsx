...
import { FaCalculator, FaChartLine, FaHandHoldingUsd, FaRegLightbulb } from "react-icons/fa";
    ...
    >
      <Stack spacing={6} textAlign="center">
        ...
        <Text
          ...
          lineHeight="1.8"
        >
          Empowering your retirement journey with clarity, confidence, and innovative financial tools.
        </Text>
      </Stack>
    </Box>
  );
...
const TeamMember = ({ name, role, bio, avatar }) => {
  return (
    ...
    >
      ...
      />
      <Heading fontSize="xl" mb={1}>{name}</Heading>
      <Text fontWeight="bold" fontSize="sm" mb={3} color={useColorModeValue("blue.600", "blue.300")}>
        {role}
      </Text>
        ...
        <VStack spacing={12}>
          ...
          <Box w="full">
            ...
            <Text fontSize="lg" lineHeight="tall" textAlign="center" maxW="3xl" mx="auto" color={textColor}>
              At Retire.Guru, we believe that everyone deserves a secure and fulfilling retirement. 
              Our mission is to demystify retirement planning through intuitive tools, 
          ...
          <Box w="full" my={6}>
            ...
            <Text fontSize="md" lineHeight="tall" mb={4} color={textColor}>
              Retire.Guru was founded by a team of financial technologists who saw firsthand how 
              traditional retirement planning tools often fell short. With backgrounds spanning 
              finance, technology, and data science, our founders set out to create tools that 
              would bring clarity to complex retirement questions.
            </Text>
            
            <Text fontSize="md" lineHeight="tall" mb={4} color={textColor}>
              What began as a simple calculator has evolved into a comprehensive platform that 
              helps people understand their retirement options with unprecedented clarity. We're 
              proud that our tools have helped thousands of individuals optimize their Social Security 
              claiming strategies, determine sustainable withdrawal rates, and find confidence in 
              their retirement plans.
            </Text>
            
            <Text fontSize="md" lineHeight="tall" color={textColor}>
              Today, we continue to refine our calculators based on the latest research and user feedback, 
              always with the goal of making retirement planning more accessible, accurate, and actionable 
              for everyone.
            </Text>
          </Box>
