        ...
        >
          ...
          >
            ...
            <Heading
              ...
              lineHeight="1.1"
            >
              Will Your Savings <Box as="span" color={accentColor}>Last</Box> in Retirement?
            </Heading>
            ...
            <Text
              ...
              lineHeight="1.6"
            >
              Calculate how long your 401(k) and Social Security will sustain your desired lifestyle. <Box as="span" fontWeight="semibold" color={highlightColor}>Plan with confidence.</Box>
            </Text>
          ...
          >
            <VStack spacing={4} align="flex-start">
              <HStack>
                <Box as="span" fontSize="3xl" color={accentColor} fontWeight="bold">
                  4%
                </Box>
