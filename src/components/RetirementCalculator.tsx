                ...
                <Box px={4} pb={4}>
                  <SimpleGrid columns={3} spacing={6}>
                    <FormNumberInput
                      ...
                      onChange={(_, value) => handleUpdateParam("initialBalance", value)}
                      placeholder="Enter starting balance..."
                      helperText="Current 401(k) or retirement savings balance"
                      step={10000}
                    />
                    <FormNumberInput
                      ...
                      onChange={(_, value) => handleUpdateParam("socialSecurity", value)}
                      placeholder="Enter Social Security..."
                      helperText="Your expected monthly Social Security benefit"
                      step={1}
                    />
                    <FormNumberInput
                      ...
                      onChange={(_, value) => handleUpdateParam("desiredMonthlyIncome", value)}
                      placeholder="Enter total monthly income..."
                      helperText="Total monthly income needed in retirement"
                      step={100}
                    />
